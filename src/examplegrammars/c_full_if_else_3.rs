...
pub fn produce_grammar_c_full_if_else_3(grammar_rules: &mut Vec::<Rule<String>>) -> (Rule<String>, crate::RuleElement<String>) {
    ...
    //     ;
    create_rule(grammar_rules, String::from("struct_or_union_specifier -> struct_or_union IDENTIFIER OPENING_SQUIGGLY_BRACKET struct_declaration_list CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
    create_rule(grammar_rules, String::from("struct_or_union_specifier -> struct_or_union OPENING_SQUIGGLY_BRACKET struct_declaration_list CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
    ...
    //     | ENUM IDENTIFIER
    //     ;
    create_rule(grammar_rules, String::from("enum_specifier -> ENUM OPENING_SQUIGGLY_BRACKET enumerator_list CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
    create_rule(grammar_rules, String::from("enum_specifier -> ENUM IDENTIFIER OPENING_SQUIGGLY_BRACKET enumerator_list CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
...
// 	// ;
    ...
    // create_rule(grammar_rules, String::from("compound_statement -> OPENING_SQUIGGLY_BRACKET CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
    // create_rule(grammar_rules, String::from("compound_statement -> OPENING_SQUIGGLY_BRACKET statement CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
    // These two rules are all you need!
    create_rule(grammar_rules, String::from("compound_statement -> OPENING_SQUIGGLY_BRACKET declaration_or_statement_list CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
    create_rule(grammar_rules, String::from("compound_statement -> OPENING_SQUIGGLY_BRACKET CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
