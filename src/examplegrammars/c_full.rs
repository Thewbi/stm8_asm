...
pub fn produce_grammar_c_full(grammar_rules: &mut Vec::<Rule<String>>) -> (Rule<String>, crate::RuleElement<String>) {
    ...
    // DEBUG
    // create_rule(&mut grammar_rules, String::from("additive_expression' -> additive_expression"), treat_nonterminal_lowercase);
    
    // create_rule(&mut grammar_rules, String::from("expression_statement' -> expression_statement"), treat_nonterminal_lowercase);
    // create_rule(&mut grammar_rules, String::from("expression' -> expression"), treat_nonterminal_lowercase);
...
//     create_rule(&mut grammar_rules, String::from("direct_declarator -> OPENING_BRACKET declarator CLOSING_BRACKET"), treat_nonterminal_lowercase);
//     create_rule(&mut grammar_rules, String::from("direct_declarator -> OPENING_BRACKET CLOSING_BRACKET"), treat_nonterminal_lowercase);

//     create_rule(&mut grammar_rules, String::from("compound_statement -> OPENING_SQUIGGLY_BRACKET declaration_or_statement_list CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
//     create_rule(&mut grammar_rules, String::from("compound_statement -> OPENING_SQUIGGLY_BRACKET CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
...
// //     create_rule(&mut grammar_rules, String::from("initializer -> OPENING_CURLY_BRACKET initializer_list CLOSING_CURLY_BRACKET"), treat_nonterminal_lowercase);
// //     create_rule(&mut grammar_rules, String::from("initializer -> OPENING_CURLY_BRACKET initializer_list COMMA CLOSING_CURLY_BRACKET"), treat_nonterminal_lowercase);
...
//     //create_rule(&mut grammar_rules, String::from("statement -> STOP_1"), treat_nonterminal_lowercase);
	...
	// ;
    create_rule(grammar_rules, String::from("compound_statement -> OPENING_SQUIGGLY_BRACKET statement_list CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
    // create_rule(&mut grammar_rules, String::from("compound_statement -> OPENING_SQUIGGLY_BRACKET CLOSING_SQUIGGLY_BRACKET"), treat_nonterminal_lowercase);
...
//     create_rule(&mut grammar_rules, String::from("selection_statement -> IF OPENING_BRACKET expression CLOSING_BRACKET statement ELSE statement"), treat_nonterminal_lowercase);

//     // ORIG 
    create_rule(grammar_rules, String::from("expression -> assignment_expression"), treat_nonterminal_lowercase);
//     create_rule(&mut grammar_rules, String::from("expression -> expression COMMA assignment_expression"), treat_nonterminal_lowercase);
//     // DEBUG
...
//     create_rule(&mut grammar_rules, String::from("unary_expression -> SIZEOF OPENING_BRACKET type_name CLOSING_BRACKET"), treat_nonterminal_lowercase);
...
//     // ORIG
//     create_rule(&mut grammar_rules, String::from("cast_expression -> OPENING_BRACKET type_name CLOSING_BRACKET cast_expression"), treat_nonterminal_lowercase);
