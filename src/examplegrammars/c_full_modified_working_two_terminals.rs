...
pub fn produce_grammar_c_full(grammar_rules: &mut Vec::<Rule<String>>) -> (Rule<String>, crate::RuleElement<String>) {
    ...
    let augmented_start_symbol = RuleElement::NonTerminal(String::from("additive_expression'"));
...
// //     // DEBUG
// //     //create_rule(grammar_rules, String::from("statement -> STOP_1"), treat_nonterminal_lowercase);
// //     // DEBUG
...
//     create_rule(grammar_rules, String::from("additive_expression -> multiplicative_expression"), treat_nonterminal_lowercase);
    // DEBUG
    create_rule(grammar_rules, String::from("additive_expression -> VOID"), treat_nonterminal_lowercase);
...
// DEBUG    
create_rule(grammar_rules, String::from("multiplicative_expression -> INT"), treat_nonterminal_lowercase);
// // 
