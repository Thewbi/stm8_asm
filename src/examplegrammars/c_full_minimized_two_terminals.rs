...
//     // ORIG 
    ...
    // DEBUG
    create_rule(grammar_rules, String::from("expression -> additive_expression"), treat_nonterminal_lowercase);
...
// DEBUG
create_rule(grammar_rules, String::from("cast_expression -> NUMERIC"), treat_nonterminal_lowercase);
