...
pub fn produce_grammar_c_full_5(grammar_rules: &mut Vec::<Rule<String>>) -> (Rule<String>, crate::RuleElement<String>) {
    ...
    // DEBUG
    create_rule(grammar_rules, String::from("conditional_expression -> VOID"), treat_nonterminal_lowercase);
