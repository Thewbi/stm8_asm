...
pub fn produce_grammar_5(grammar_rules: &mut Vec::<Rule<String>>) -> (Rule<String>, crate::RuleElement<String>) {
    ...
    create_rule(grammar_rules, String::from("S -> L"), treat_nonterminal_lowercase);

    create_rule(grammar_rules, String::from("L -> L ; id"), treat_nonterminal_lowercase);
    create_rule(grammar_rules, String::from("L -> id"), treat_nonterminal_lowercase);
