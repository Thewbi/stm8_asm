...
pub fn produce_grammar_6(grammar_rules: &mut Vec::<Rule<String>>) -> (Rule<String>, crate::RuleElement<String>) {
    ...
    // https://lambda.uta.edu/cse5317/spring18/notes/node21.html
    //
    // S ::= E $
    // E ::= E + E
    //     | E * E
    ...
    create_rule(grammar_rules, String::from("S -> E"), treat_nonterminal_lowercase);

    create_rule(grammar_rules, String::from("E -> E + E"), treat_nonterminal_lowercase);
    create_rule(grammar_rules, String::from("E -> E * E"), treat_nonterminal_lowercase);
    create_rule(grammar_rules, String::from("E -> ( E )"), treat_nonterminal_lowercase);
    create_rule(grammar_rules, String::from("E -> id"), treat_nonterminal_lowercase);
    create_rule(grammar_rules, String::from("E -> num"), treat_nonterminal_lowercase);
