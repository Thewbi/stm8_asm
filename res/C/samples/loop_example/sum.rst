      ...
      008000 82 00 80 07             44 	int s_GSINIT ; reset
                                     ...
                                     50 	.area GSFINAL
                                     51 	.area GSINIT
      008007 CD 80 83         [ 4]   52 	call	___sdcc_external_startup
      ...
      008066 1F 19            [ 2]  120 	ldw	(0x19, sp), x
                                    121 ;	sum.c: 6: while (data[i] != 0xaa) {
      008068                        122 00101$:
      008068 1E 19            [ 2]  123 	ldw	x, (0x19, sp)
      00806A 58               [ 2]  124 	sllw	x
      00806B 1F 17            [ 2]  125 	ldw	(0x17, sp), x
      00806D 96               [ 1]  126 	ldw	x, sp
      00806E 5C               [ 1]  127 	incw	x
      00806F 72 FB 17         [ 2]  128 	addw	x, (0x17, sp)
      008072 FE               [ 2]  129 	ldw	x, (x)
      008073 A3 00 AA         [ 2]  130 	cpw	x, #0x00aa
      008076 27 07            [ 1]  131 	jreq	00103$
                                    132 ;	sum.c: 7: i = i + data[i];
      008078 72 FB 19         [ 2]  133 	addw	x, (0x19, sp)
      00807B 1F 19            [ 2]  134 	ldw	(0x19, sp), x
      00807D 20 E9            [ 2]  135 	jra	00101$
      00807F                        136 00103$:
                                    137 ;	sum.c: 10: return 0;
      00807F 5F               [ 1]  138 	clrw	x
                                    139 ;	sum.c: 11: }
      008080 5B 1A            [ 2]  140 	addw	sp, #26
      008082 81               [ 4]  141 	ret
                                    142 	.area CODE
                                    143 	.area CONST
